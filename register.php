	...
	<div class="wrapper">
		...
		<div id="second">	
			...
			<form action="register.php"method="POST">
				...
				else if(in_array("Invalid Email Format<br>", $error_array)) echo "Email already in use<br>";
				...
				else if(in_array("your password can only contain english charecter or numbers<br>", $error_array)) echo "your password can only contain english charecter or numbers<br>";
				 
				else if(in_array("Your password must be 5-30 characters<br>", $error_array)) echo "Your password must be 5-30 characters<br>"; ?>

				<input type="submit" name="register_button"value="Register">
				<br>

				<?php if(in_array("<span style='color: #14C800;'> You all set Go ahead and login!</span><br>", $error_array)) echo "<span style='color: #14C800;'> You all set Go ahead and login!</span><br>"; ?>
